...
points(ml1.ts[,2], type="l", col="blue",lwd=2.8)
points(ml1.ts[,3], type="l", col="red",lwd=2.8)
points(ml1.ts[,4], type="l", col="pink",lwd=2.8)
legend("bottomleft", c("Industrial Production","ADL","Elastic Net","Random Forest"), lty=c(1,1,1,1) ,col=c("black","blue","red","pink"))
#Create the time series object collecting 1-step best=performing ML forecasts
ml12.ts=ts(cbind(oosy,bar12c$pred,elasticnet12c$pred,rf12c$pred), start=c(2010,1), end=c(2024,7), freq=12)
plot.ts(ml12.ts[,1], main="1-step ML forecasts", cex.axis=1.5, lwd=2, ylab="Industrial Production")
points(ml12.ts[,2], type="l", col="blue",lwd=2.8)
points(ml12.ts[,3], type="l", col="red",lwd=2.8)
points(ml12.ts[,4], type="l", col="pink",lwd=2.8)
legend("bottomleft", c("Industrial Production","ADL","Elastic Net","Random Forest"), lty=c(1,1,1,1) ,col=c("black","blue","red","pink"))
###########
# Bagging
###########
